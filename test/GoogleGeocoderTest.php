...
require_once dirname(__FILE__).'/../lib/geocoders/GoogleGeocoder.php';
require_once dirname(__FILE__).'/../lib/GeoPHP.php';

class GoogleGeocoderTest extends PHPUnit_Extensions_ExceptionTestCase
{

	public function test01_locate()
	{
		// Test with no options and empty location string.
		$this->setExpectedException('GeoPhp_GoogleGeocoderError');
		$coder = new GeoPHP_GoogleGeocoder("ABQIAAAA1WyaXpV_0Jhp1knJV5i7XRST-KG1lUPPqvb7mBlZbBX29iXO4hRN4syFNonIVSGmte-rI23N8vijwQ");
		$result = $coder->locate("");
	}
	...
	public function test02_locate()
	{
		...
		$this->assertEquals(41.684168, $result[0]['coordiantes']->x);
	}
	...
	public function test04_locate()
	{
		...
		$coder = new GeoPHP_GoogleGeocoder("ABQIAAAA1WyaXpV_0Jhp1knJV5i7XRST-KG1lUPPqvb7mBlZbBX29iXO4hRN4syFNonIVSGmte-rI23N8vijwQ",array("cache" => $flle_path));
